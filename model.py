...
class CNN_large(nn.Module):
    def __init__(self, input_channel=3, n_outputs=10, dropout_rate=0.25, top_bn=False):
        ...
        self.bn1=nn.BatchNorm2d(128,momentum=0.5)
        self.bn2=nn.BatchNorm2d(128,momentum=0.5)
        ...
        self.bn8=nn.BatchNorm2d(256,momentum=0.5)
        self.bn9=nn.BatchNorm2d(128,momentum=0.5)
